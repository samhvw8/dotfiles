...
description: Automated codebase refactoring using ast-grep for structural transformations, sed for text replacements, and ripgrep for validation. Applies SOLID principles, design patterns, and clean code practices across entire codebases with safe, atomic transformations.
